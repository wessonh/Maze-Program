...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        try {
            ...
            newCustom.setOnAction(value -> { // newCustom button
            ...
            next.setOnAction(value -> {
                try {
                    ...
                    maze = Gen.animateGen(group2, x, y, () -> {
                        ...
                        group2.getChildren().addAll(newCustom, back, solveButton, saveButton);
                        enterRows.clear();
                        enterColumns.clear();
            ...
            genButton.setOnAction(value -> { // gen button
            ...
            back.setOnAction(value ->  { // back button

                group2.getChildren().clear();
                stage.setScene(scene);
            });

            clearButton.setOnAction(value ->  { // clear button

                group2.getChildren().clear();
                group2.getChildren().addAll(genButton, back, saveButton, loadButton, solveButton);
            ...
            loadButton.setOnAction(e -> {
                ...
                if (loadedMaze != null) {
                    ...
                    maze = Gen.animateGen(group2, x, y, () -> {
                        genButton.setDisable(true); // Enable gen Button
                        solveButton.setDisable(false);
                    ...
                    group2.getChildren().addAll(genButton, solveButton, saveButton, loadButton, back, clearButton);
                    genButton.setDisable(true); // enable gen Button
                    solveButton.setDisable(false);
                    clearButton.setVisible(true);
                }

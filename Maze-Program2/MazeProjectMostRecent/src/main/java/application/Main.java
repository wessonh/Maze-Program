/*
Maze Generator for CS 240

Henry Wesson, Michael Woo, Jack Pate
 */
...
public class Main extends Application {
    ...
    static final Group group4 = new Group();
    static Node[][] maze;
    static Stage stage;
    ...
    public void start(Stage primaryStage) {
        ...
        try {
            ...
            Scene scene4 = new Scene(group4, 600, 600);
            ...
            saveButton.setOnAction(e -> SaveLoad.save(maze));
            ...
            loadButtons(scene2, loadButton, loadButton);

            loadButtons(scene2, loadButton, loadButton2);

            solveButton.setOnAction(e -> {
                Solve solver = new Solve();
                solver.animateSolve(maze, solverDone);
                solveButton.setDisable(true);
                clearButton.setDisable(true);
                back.setDisable(true);
    ...
    private void loadButtons(Scene scene2, Button loadButton, Button loadButton2) {
